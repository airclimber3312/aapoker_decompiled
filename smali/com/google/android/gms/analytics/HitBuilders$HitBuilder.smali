...
# instance fields
.field private zzduq:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private zzdur:Lcom/google/android/gms/analytics/ecommerce/ProductAction;

.field private zzdus:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private zzdut:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private zzduu:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/google/android/gms/analytics/ecommerce/Product;",
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzduq:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdus:Ljava/util/Map;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdut:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzduu:Ljava/util/List;

    return-void
.end method

.method private final zzh(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzduq:Ljava/util/Map;
...
.method public addImpression(Lcom/google/android/gms/analytics/ecommerce/Product;Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    invoke-static {p1}, Lcom/google/android/gms/internal/zzatc;->zzcz(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdus:Ljava/util/Map;
...
.method public addProduct(Lcom/google/android/gms/analytics/ecommerce/Product;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzduu:Ljava/util/List;
...
.method public addPromotion(Lcom/google/android/gms/analytics/ecommerce/Promotion;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdut:Ljava/util/List;
...
.method public build()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzduq:Ljava/util/Map;

    invoke-direct {v0, v1}, Ljava/util/HashMap;-><init>(Ljava/util/Map;)V

    iget-object v1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdur:Lcom/google/android/gms/analytics/ecommerce/ProductAction;
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdut:Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/google/android/gms/analytics/zzd;->zzao(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/google/android/gms/analytics/ecommerce/Promotion;->zzdx(Ljava/lang/String;)Ljava/util/Map;
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzduu:Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/google/android/gms/analytics/zzd;->zzam(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/google/android/gms/analytics/ecommerce/Product;->zzdx(Ljava/lang/String;)Ljava/util/Map;
    ...
    :cond_2
    iget-object v1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdus:Ljava/util/Map;
    ...
    invoke-static {v3}, Lcom/google/android/gms/analytics/zzd;->zzar(I)Ljava/lang/String;
...
.method public setCampaignParamsFromUrl(Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    invoke-static {p1}, Lcom/google/android/gms/internal/zzatt;->zzep(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/internal/zzatt;->zzen(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzh(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzh(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
...
.method public setCustomMetric(IF)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    invoke-static {p1}, Lcom/google/android/gms/analytics/zzd;->zzak(I)Ljava/lang/String;
...
.method public setProductAction(Lcom/google/android/gms/analytics/ecommerce/ProductAction;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    iput-object p1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzdur:Lcom/google/android/gms/analytics/ecommerce/ProductAction;
