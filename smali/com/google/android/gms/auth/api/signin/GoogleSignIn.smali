...
.method public static getAccountForExtension(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptionsExtension;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-static {}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->zzacd()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-static {p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignIn;->zzw(Ljava/util/List;)[Lcom/google/android/gms/common/api/Scope;
...
.method public static getLastSignedInAccount(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/auth/api/signin/internal/zzp;->zzacp()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
...
.method public static getSignedInAccountFromIntent(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {p0}, Lcom/google/android/gms/auth/api/signin/internal/zzf;->getSignInResultFromIntent(Landroid/content/Intent;)Lcom/google/android/gms/auth/api/signin/GoogleSignInResult;

    move-result-object p0

    if-nez p0, :cond_0

    sget-object p0, Lcom/google/android/gms/common/api/Status;->zzfts:Lcom/google/android/gms/common/api/Status;
...
.method public static requestPermissions(Landroid/app/Activity;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptionsExtension;)V
    ...
    invoke-static {p3}, Lcom/google/android/gms/auth/api/signin/GoogleSignIn;->zzw(Ljava/util/List;)[Lcom/google/android/gms/common/api/Scope;
