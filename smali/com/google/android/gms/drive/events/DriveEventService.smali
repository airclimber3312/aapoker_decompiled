...
.field private zzgsa:Ljava/util/concurrent/CountDownLatch;

.field zzgsb:Lcom/google/android/gms/drive/events/DriveEventService$zza;

.field zzgsc:Z

.field private zzgsd:I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgpv:Lcom/google/android/gms/common/internal/zzal;
...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsc:Z

    const/4 v0, -0x1

    iput v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsd:I
...
.method static synthetic zza(Lcom/google/android/gms/drive/events/DriveEventService;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/drive/events/DriveEventService;->zzaqb()V

    return-void
.end method

.method static synthetic zza(Lcom/google/android/gms/drive/events/DriveEventService;Lcom/google/android/gms/internal/zzbsf;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/gms/drive/events/DriveEventService;->zza(Lcom/google/android/gms/internal/zzbsf;)V

    return-void
.end method

.method private final zza(Lcom/google/android/gms/internal/zzbsf;)V
    .locals 7
    ...
    sget-object v0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgpv:Lcom/google/android/gms/common/internal/zzal;
    ...
    const-string v4, "DriveEventService"

    const-string v5, "handleEventMessage: %s"

    invoke-virtual {v0, v4, v5, v2}, Lcom/google/android/gms/common/internal/zzal;->zzb(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v4, v2, v5}, Lcom/google/android/gms/common/internal/zzal;->zzc(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v2, "Unhandled transfer state event in %s: %s"
    ...
    const-string v2, "Error handling event in %s"

    invoke-static {v2, v1}, Ljava/lang/String;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v4, v1, p1}, Lcom/google/android/gms/common/internal/zzal;->zzd(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void
.end method

.method private final zzaqb()V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
    ...
    iget v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsd:I
    ...
    :cond_0
    invoke-static {p0, v0}, Lcom/google/android/gms/common/util/zzz;->zze(Landroid/content/Context;I)Z
...
.method static synthetic zzb(Lcom/google/android/gms/drive/events/DriveEventService;)Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object p0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsa:Ljava/util/concurrent/CountDownLatch;
...
.method public final declared-synchronized onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsb:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    if-nez p1, :cond_0

    iget-boolean p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsc:Z

    if-nez p1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsc:Z
    ...
    iput-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsa:Ljava/util/concurrent/CountDownLatch;
    ...
    sget-object p1, Lcom/google/android/gms/drive/events/DriveEventService;->zzgpv:Lcom/google/android/gms/common/internal/zzal;
...
.method public onChange(Lcom/google/android/gms/drive/events/ChangeEvent;)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Lcom/google/android/gms/common/internal/zzal;->zzc(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public declared-synchronized onDestroy()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsb:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    if-eqz v1, :cond_1

    invoke-static {v1}, Lcom/google/android/gms/drive/events/DriveEventService$zza;->zza(Lcom/google/android/gms/drive/events/DriveEventService$zza;)Landroid/os/Message;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsb:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    invoke-virtual {v2, v1}, Lcom/google/android/gms/drive/events/DriveEventService$zza;->sendMessage(Landroid/os/Message;)Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsb:Lcom/google/android/gms/drive/events/DriveEventService$zza;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object v2, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzgsa:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/google/android/gms/common/internal/zzal;->zzv(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/InterruptedException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
