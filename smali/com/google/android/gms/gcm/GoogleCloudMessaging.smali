...
.field private static zzika:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

.field private static final zzikd:Ljava/util/concurrent/atomic/AtomicInteger;
...
.field private final zzikc:Ljava/util/Map;
...
.field private final zzike:Ljava/util/concurrent/BlockingQueue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikd:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikc:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-direct {v0}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzike:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikf:Landroid/os/Messenger;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzika:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzika:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    iput-object p0, v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaiq:Landroid/content/Context;

    :cond_0
    sget-object p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzika:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    :try_end_0
...
.method private final zza(Landroid/os/Bundle;Z)Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaiq:Landroid/content/Context;

    invoke-static {v0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzdn(Landroid/content/Context;)I
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaiq:Landroid/content/Context;

    invoke-static {v1}, Lcom/google/android/gms/iid/zzaa;->zzdr(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    invoke-direct {p0, v0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzg(Landroid/content/Intent;)V

    sget-object v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikd:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikf:Landroid/os/Messenger;

    invoke-virtual {v0, p1, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    iget-object p1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaiq:Landroid/content/Context;
    ...
    :goto_1
    :try_start_0
    iget-object p1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzike:Ljava/util/concurrent/BlockingQueue;
...
.method static synthetic zza(Lcom/google/android/gms/gcm/GoogleCloudMessaging;)Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object p0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzike:Ljava/util/concurrent/BlockingQueue;
...
.method private final declared-synchronized zzawh()V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikb:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikb:Landroid/app/PendingIntent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static synthetic zzb(Lcom/google/android/gms/gcm/GoogleCloudMessaging;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaiq:Landroid/content/Context;
...
.method public static zzdn(Landroid/content/Context;)I
    .locals 2
...
.method private final zzf(Landroid/content/Intent;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikc:Ljava/util/Map;
...
.method private final declared-synchronized zzg(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzikb:Landroid/app/PendingIntent;
...
.method public close()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzika:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    sput-object v0, Lcom/google/android/gms/gcm/zza;->zzijk:Lcom/google/android/gms/gcm/zza;

    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzawh()V
...
.method public varargs declared-synchronized register([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/iid/zzaa;->zzdq(Landroid/content/Context;)Z
...
.method public send(Ljava/lang/String;Ljava/lang/String;JLandroid/os/Bundle;)V
    ...
    :goto_0
    iget-object p4, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaiq:Landroid/content/Context;
    ...
    invoke-virtual {p4, v4, p3, v5}, Lcom/google/android/gms/iid/zzaf;->zzf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo p2, "upstream"

    invoke-virtual {p1, v5, p2, p3}, Lcom/google/android/gms/iid/InstanceID;->zzb(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
