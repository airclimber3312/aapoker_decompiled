.class final Lcom/google/android/gms/internal/zzbrc;
...
.method private constructor <init>(Landroid/os/Looper;Landroid/content/Context;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zzbrc;->mContext:Landroid/content/Context;

    return-void
.end method

.method synthetic constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/google/android/gms/internal/zzbrb;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/internal/zzbrc;-><init>(Landroid/os/Looper;Landroid/content/Context;)V
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {}, Lcom/google/android/gms/internal/zzbra;->zzaqc()Lcom/google/android/gms/common/internal/zzal;

    move-result-object p1

    new-array v0, v3, [Ljava/lang/Object;

    iget-object v3, p0, Lcom/google/android/gms/internal/zzbrc;->mContext:Landroid/content/Context;

    aput-object v3, v0, v1

    const-string v1, "Don\'t know how to handle this event in context %s"

    invoke-virtual {p1, v2, v1, v0}, Lcom/google/android/gms/common/internal/zzal;->zzd(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v2, p1, v3}, Lcom/google/android/gms/common/internal/zzal;->zzc(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzr;->zzaqh()Lcom/google/android/gms/internal/zzblw;

    move-result-object p1

    new-instance v1, Lcom/google/android/gms/internal/zzblt;

    invoke-direct {v1, p1}, Lcom/google/android/gms/internal/zzblt;-><init>(Lcom/google/android/gms/internal/zzblw;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzo;->zzaqe()Lcom/google/android/gms/common/data/DataHolder;
    ...
    invoke-direct {v1, v2}, Lcom/google/android/gms/internal/zzbrd;-><init>(Lcom/google/android/gms/drive/MetadataBuffer;)V

    invoke-interface {v0, v1}, Lcom/google/android/gms/drive/events/zzq;->zza(Lcom/google/android/gms/drive/events/zzn;)V

    :cond_4
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzo;->zzaqf()Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzo;->zzaqg()I

    move-result p1

    invoke-interface {v0, p1}, Lcom/google/android/gms/drive/events/zzq;->zzcs(I)V
