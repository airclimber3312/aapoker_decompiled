...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoj:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkok:Ljava/util/regex/Pattern;
...
.method constructor <init>(Lcom/google/android/gms/tagmanager/DataLayer$zzc;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkop:Lcom/google/android/gms/tagmanager/DataLayer$zzc;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkol:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkom:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkon:Ljava/util/concurrent/locks/ReentrantLock;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoo:Ljava/util/LinkedList;
    ...
    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoq:Ljava/util/concurrent/CountDownLatch;
...
.method static synthetic zza(Lcom/google/android/gms/tagmanager/DataLayer;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/tagmanager/DataLayer;->zzaa(Ljava/util/Map;)V
...
.method private final zza(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/google/android/gms/tagmanager/DataLayer;->zzd(Ljava/util/Map;Ljava/util/Map;)V
...
.method private final zzaa(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkon:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoo:Ljava/util/LinkedList;
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoo:Ljava/util/LinkedList;
    ...
    iget-object v3, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkom:Ljava/util/Map;
    ...
    invoke-static {v5, v6}, Lcom/google/android/gms/tagmanager/DataLayer;->zzn(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Map;

    move-result-object v5

    iget-object v6, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkom:Ljava/util/Map;

    invoke-direct {p0, v5, v6}, Lcom/google/android/gms/tagmanager/DataLayer;->zzd(Ljava/util/Map;Ljava/util/Map;)V
    ...
    :try_start_2
    iget-object v3, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkol:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v4, Lcom/google/android/gms/tagmanager/DataLayer$zzb;

    invoke-interface {v4, v2}, Lcom/google/android/gms/tagmanager/DataLayer$zzb;->zzy(Ljava/util/Map;)V
    ...
    :cond_2
    iget-object p1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoo:Ljava/util/LinkedList;
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/android/gms/tagmanager/DataLayer;->zzab(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/google/android/gms/tagmanager/DataLayer;->zzln(Ljava/lang/String;)Ljava/lang/Long;
    ...
    iget-object p1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkop:Lcom/google/android/gms/tagmanager/DataLayer$zzc;

    invoke-virtual {v0}, Ljava/lang/Long;->longValue()J

    move-result-wide v2

    invoke-interface {p1, v1, v2, v3}, Lcom/google/android/gms/tagmanager/DataLayer$zzc;->zza(Ljava/util/List;J)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_1

    :cond_5
    iget-object p1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkon:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private final zzd(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct {p0, v2, v1}, Lcom/google/android/gms/tagmanager/DataLayer;->zzd(Ljava/util/Map;Ljava/util/Map;)V
...
.method public push(Ljava/util/Map;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkoq:Ljava/util/concurrent/CountDownLatch;
...
.method final zza(Lcom/google/android/gms/tagmanager/DataLayer$zzb;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkol:Ljava/util/concurrent/ConcurrentHashMap;
...
.method final zzlm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->zzkop:Lcom/google/android/gms/tagmanager/DataLayer$zzc;

    invoke-interface {v0, p1}, Lcom/google/android/gms/tagmanager/DataLayer$zzc;->zzlo(Ljava/lang/String;)V
