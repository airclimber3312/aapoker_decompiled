...
.method private constructor <init>(Landroid/content/Context;Lcom/google/android/gms/internal/zzfap;Lcom/google/android/gms/internal/zzfap;Lcom/google/android/gms/internal/zzfap;Lcom/google/android/gms/internal/zzfas;)V
    ...
    :cond_0
    new-instance p5, Lcom/google/android/gms/internal/zzfas;

    invoke-direct {p5}, Lcom/google/android/gms/internal/zzfas;-><init>()V

    :goto_0
    iput-object p5, p0, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zzose:Lcom/google/android/gms/internal/zzfas;

    iget-object p5, p0, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zzose:Lcom/google/android/gms/internal/zzfas;

    invoke-direct {p0, p1}, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zzfi(Landroid/content/Context;)J

    move-result-wide v0

    invoke-virtual {p5, v0, v1}, Lcom/google/android/gms/internal/zzfas;->zzco(J)V
...
.method public static getInstance()Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;
    ...
    invoke-static {v2}, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zzfj(Landroid/content/Context;)Lcom/google/android/gms/internal/zzfax;
    ...
    const-string v0, "No persisted config was found. Initializing from scratch."
    ...
    invoke-direct {v0, v2}, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;-><init>(Landroid/content/Context;)V
    ...
    const-string v1, "Initializing from persisted config."
    ...
    :cond_3
    new-instance v6, Lcom/google/android/gms/internal/zzfas;

    invoke-direct {v6}, Lcom/google/android/gms/internal/zzfas;-><init>()V

    iget v7, v1, Lcom/google/android/gms/internal/zzfav;->zzota:I

    invoke-virtual {v6, v7}, Lcom/google/android/gms/internal/zzfas;->zziy(I)V

    iget-boolean v7, v1, Lcom/google/android/gms/internal/zzfav;->zzotb:Z

    invoke-virtual {v6, v7}, Lcom/google/android/gms/internal/zzfas;->zzdd(Z)V

    iget-wide v7, v1, Lcom/google/android/gms/internal/zzfav;->zzotc:J

    invoke-virtual {v6, v7, v8}, Lcom/google/android/gms/internal/zzfas;->zzcp(J)V
    ...
    invoke-virtual {v6, v0}, Lcom/google/android/gms/internal/zzfas;->zzav(Ljava/util/Map;)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;-><init>(Landroid/content/Context;Lcom/google/android/gms/internal/zzfap;Lcom/google/android/gms/internal/zzfap;Lcom/google/android/gms/internal/zzfap;Lcom/google/android/gms/internal/zzfas;)V
...
.method private static zza(Lcom/google/android/gms/internal/zzfat;)Lcom/google/android/gms/internal/zzfap;
    ...
    invoke-direct {v1, v0, v3, v4, v2}, Lcom/google/android/gms/internal/zzfap;-><init>(Ljava/util/Map;JLjava/util/List;)V
...
.method private static zzfj(Landroid/content/Context;)Lcom/google/android/gms/internal/zzfax;
    ...
    :cond_0
    :try_start_0
    const-string v3, "persisted_config"
    ...
    invoke-static {p0, v3}, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zza(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    invoke-static {v3, v5, v4}, Lcom/google/android/gms/internal/zzflj;->zzo([BII)Lcom/google/android/gms/internal/zzflj;

    move-result-object v3

    new-instance v4, Lcom/google/android/gms/internal/zzfax;

    invoke-direct {v4}, Lcom/google/android/gms/internal/zzfax;-><init>()V
...
.method public setDefaults(ILjava/lang/String;)V
    ...
    const-string p1, "namespace cannot be null for setDefaults."
    ...
    check-cast v2, Lcom/google/android/gms/internal/zzfam;

    invoke-virtual {v2}, Lcom/google/android/gms/internal/zzfam;->getResourceId()I

    move-result v3

    if-ne p1, v3, :cond_3

    iget-object v3, p0, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zzose:Lcom/google/android/gms/internal/zzfas;

    invoke-virtual {v3}, Lcom/google/android/gms/internal/zzfas;->zzcno()J

    move-result-wide v3

    invoke-virtual {v2}, Lcom/google/android/gms/internal/zzfam;->zzcnk()J
    ...
    const-string p1, "Skipped setting defaults from resource file as this resource file was already applied."
    ...
    invoke-direct {v0, p1, v3, v4}, Lcom/google/android/gms/internal/zzfam;-><init>(IJ)V
    ...
    invoke-direct {p0, v2, p2, p1}, Lcom/google/firebase/remoteconfig/FirebaseRemoteConfig;->zzc(Ljava/util/Map;Ljava/lang/String;Z)V
    :try_end_1
    ...
    const-string p2, "Caught exception while parsing XML resource. Skipping setDefaults."
