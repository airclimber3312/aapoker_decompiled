...
# instance fields
.field private final zzoux:Landroid/net/Uri;

.field private final zzouy:Lcom/google/firebase/storage/FirebaseStorage;
...
.method constructor <init>(Landroid/net/Uri;Lcom/google/firebase/storage/FirebaseStorage;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/storage/StorageReference;->zzoux:Landroid/net/Uri;

    iput-object p2, p0, Lcom/google/firebase/storage/StorageReference;->zzouy:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public child(Ljava/lang/String;)Lcom/google/firebase/storage/StorageReference;
    ...
    invoke-static {p1}, Lcom/google/android/gms/internal/zzfbd;->zzsp(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/storage/StorageReference;->zzoux:Landroid/net/Uri;

    invoke-virtual {v0}, Landroid/net/Uri;->buildUpon()Landroid/net/Uri$Builder;

    move-result-object v0

    invoke-static {p1}, Lcom/google/android/gms/internal/zzfbd;->zzsn(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/firebase/storage/StorageReference;->zzouy:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public delete()Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v1, Lcom/google/firebase/storage/zzb;

    invoke-direct {v1, p0, v0}, Lcom/google/firebase/storage/zzb;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public getActiveDownloadTasks()Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, Lcom/google/firebase/storage/zzt;->zzb(Lcom/google/firebase/storage/StorageReference;)Ljava/util/List;
...
.method public getActiveUploadTasks()Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, Lcom/google/firebase/storage/zzt;->zza(Lcom/google/firebase/storage/StorageReference;)Ljava/util/List;
...
.method public getBytes(J)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0, p1, p2, v0}, Lcom/google/firebase/storage/zzi;-><init>(Lcom/google/firebase/storage/StorageReference;JLcom/google/android/gms/tasks/TaskCompletionSource;)V

    invoke-virtual {v1, v2}, Lcom/google/firebase/storage/StreamDownloadTask;->zza(Lcom/google/firebase/storage/StreamDownloadTask$StreamProcessor;)Lcom/google/firebase/storage/StreamDownloadTask;

    move-result-object p1

    new-instance p2, Lcom/google/firebase/storage/zzh;

    invoke-direct {p2, p0, v0}, Lcom/google/firebase/storage/zzh;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V

    invoke-virtual {p1, p2}, Lcom/google/android/gms/tasks/Task;->addOnSuccessListener(Lcom/google/android/gms/tasks/OnSuccessListener;)Lcom/google/android/gms/tasks/Task;

    move-result-object p1

    check-cast p1, Lcom/google/firebase/storage/StorageTask;

    new-instance p2, Lcom/google/firebase/storage/zzg;

    invoke-direct {p2, p0, v0}, Lcom/google/firebase/storage/zzg;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V

    invoke-virtual {p1, p2}, Lcom/google/android/gms/tasks/Task;->addOnFailureListener(Lcom/google/android/gms/tasks/OnFailureListener;)Lcom/google/android/gms/tasks/Task;

    invoke-virtual {v1}, Lcom/google/firebase/storage/StorageTask;->zzcny()Z
...
.method public getDownloadUrl()Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v2, Lcom/google/firebase/storage/zze;

    invoke-direct {v2, p0, v0}, Lcom/google/firebase/storage/zze;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V

    invoke-virtual {v1, v2}, Lcom/google/android/gms/tasks/Task;->addOnSuccessListener(Lcom/google/android/gms/tasks/OnSuccessListener;)Lcom/google/android/gms/tasks/Task;

    new-instance v2, Lcom/google/firebase/storage/zzf;

    invoke-direct {v2, p0, v0}, Lcom/google/firebase/storage/zzf;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public getFile(Landroid/net/Uri;)Lcom/google/firebase/storage/FileDownloadTask;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/storage/StorageTask;->zzcny()Z
...
.method public getMetadata()Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v1, Lcom/google/firebase/storage/zzc;

    invoke-direct {v1, p0, v0}, Lcom/google/firebase/storage/zzc;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method public getParent()Lcom/google/firebase/storage/StorageReference;
    ...
    iget-object v2, p0, Lcom/google/firebase/storage/StorageReference;->zzouy:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public getStorage()Lcom/google/firebase/storage/FirebaseStorage;
    ...
    iget-object v0, p0, Lcom/google/firebase/storage/StorageReference;->zzouy:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/firebase/storage/StorageReference;->zzoux:Landroid/net/Uri;
...
.method public updateMetadata(Lcom/google/firebase/storage/StorageMetadata;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, p0, v0, p1}, Lcom/google/firebase/storage/zzac;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/firebase/storage/StorageMetadata;)V
...
.method final zzcnw()Lcom/google/android/gms/internal/zzfbm;
    .locals 1
...
.method final zzcnx()Landroid/net/Uri;
    .locals 1
