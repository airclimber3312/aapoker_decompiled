...
.field private final zzovn:Ljava/lang/Exception;
...
.method public constructor <init>(Lcom/google/firebase/storage/StorageTask;Ljava/lang/Exception;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/storage/StorageTask$SnapshotBase;->zzovk:Lcom/google/firebase/storage/StorageTask;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    if-nez p2, :cond_2

    invoke-virtual {p1}, Lcom/google/firebase/storage/CancellableTask;->isCanceled()Z

    move-result p2

    if-eqz p2, :cond_0

    sget-object p1, Lcom/google/android/gms/common/api/Status;->zzftu:Lcom/google/android/gms/common/api/Status;
    ...
    :goto_1
    iput-object p1, p0, Lcom/google/firebase/storage/StorageTask$SnapshotBase;->zzovn:Ljava/lang/Exception;

    return-void

    :cond_0
    invoke-virtual {p1}, Lcom/google/firebase/storage/StorageTask;->zzcnz()I
    ...
    :cond_2
    iput-object p2, p0, Lcom/google/firebase/storage/StorageTask$SnapshotBase;->zzovn:Ljava/lang/Exception;
...
.method public getError()Ljava/lang/Exception;
    ...
    iget-object v0, p0, Lcom/google/firebase/storage/StorageTask$SnapshotBase;->zzovn:Ljava/lang/Exception;
...
.method public getTask()Lcom/google/firebase/storage/StorageTask;
    ...
    iget-object v0, p0, Lcom/google/firebase/storage/StorageTask$SnapshotBase;->zzovk:Lcom/google/firebase/storage/StorageTask;
