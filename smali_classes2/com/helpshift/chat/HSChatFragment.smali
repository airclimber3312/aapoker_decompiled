...
.method public onResume()V
    ...
    invoke-virtual {v1}, Lcom/helpshift/core/HSContext;->getConversationPoller()Lcom/helpshift/poller/ConversationPoller;
    ...
    .line 216
    invoke-virtual {v1, p0}, Lcom/helpshift/util/network/connectivity/HSConnectivityManager;->registerNetworkConnectivityListener(Lcom/helpshift/util/network/connectivity/HSNetworkConnectivityCallback;)V
    ...
    .line 219
    invoke-virtual {v1}, Lcom/helpshift/core/HSContext;->isWebchatUIOpen()Z

    move-result v3

    if-eqz v3, :cond_1

    iget-boolean v3, p0, Lcom/helpshift/chat/HSChatFragment;->isWebchatSourceChanged:Z

    if-eqz v3, :cond_1

    const-string v3, "Updating config with latest config in same webchat session"
    ...
    invoke-virtual {v3, v1}, Lcom/helpshift/config/HSConfigManager;->getWebchatConfigJs(Z)Ljava/lang/String;
...
.method public requestConversationMetadata(Ljava/lang/String;)V
    ...
    const-string v1, "Helpshift(\'syncConversationMetadata\',JSON.stringify("
    ...
    invoke-virtual {v3}, Lcom/helpshift/core/HSContext;->getConfigManager()Lcom/helpshift/config/HSConfigManager;

    move-result-object v3

    .line 367
    invoke-virtual {v3, p1}, Lcom/helpshift/config/HSConfigManager;->getBreadCrumbs(I)Lorg/json/JSONArray;

    move-result-object p1

    .line 368
    invoke-virtual {v3, v4}, Lcom/helpshift/config/HSConfigManager;->getDebugLogs(I)Lorg/json/JSONArray;
...
.method public setHelpcenterData()V
    ...
    const-string v1, "Helpshift(\'setHelpcenterData\',\'"
    ...
    invoke-virtual {v2}, Lcom/helpshift/config/HSConfigManager;->getAdditionalInfo()Ljava/lang/String;
...
.method public updateWebchatConfig()V
    ...
    const-string v0, "));Helpshift(\'updateHelpshiftConfig\')"
