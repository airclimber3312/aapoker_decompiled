...
.method public initialiseComponents(Landroid/content/Context;)V
    ...
    iget-object v12, v0, Lcom/helpshift/core/HSContext;->persistentStorage:Lcom/helpshift/storage/HSPersistentStorage;

    iget-object v13, v0, Lcom/helpshift/core/HSContext;->pushTokenManager:Lcom/helpshift/notification/HSPushTokenManager;

    iget-object v14, v0, Lcom/helpshift/core/HSContext;->genericDataManager:Lcom/helpshift/storage/HSGenericDataManager;

    iget-object v15, v0, Lcom/helpshift/core/HSContext;->hsThreadingService:Lcom/helpshift/concurrency/HSThreadingService;

    iget-object v2, v0, Lcom/helpshift/core/HSContext;->notificationManager:Lcom/helpshift/notification/CoreNotificationManager;

    move-object v11, v1

    move-object/from16 v16, v2

    invoke-direct/range {v11 .. v16}, Lcom/helpshift/user/UserManager;-><init>(Lcom/helpshift/storage/HSPersistentStorage;Lcom/helpshift/notification/HSPushTokenManager;Lcom/helpshift/storage/HSGenericDataManager;Lcom/helpshift/concurrency/HSThreadingService;Lcom/helpshift/notification/CoreNotificationManager;)V

    iput-object v1, v0, Lcom/helpshift/core/HSContext;->userManager:Lcom/helpshift/user/UserManager;
    ...
    iget-object v4, v0, Lcom/helpshift/core/HSContext;->analyticsManager:Lcom/helpshift/analytics/HSWebchatAnalyticsManager;

    iget-object v5, v0, Lcom/helpshift/core/HSContext;->device:Lcom/helpshift/platform/Device;

    invoke-direct {v2, v3, v4, v5, v1}, Lcom/helpshift/config/HSConfigManager;-><init>(Lcom/helpshift/storage/HSPersistentStorage;Lcom/helpshift/analytics/HSWebchatAnalyticsManager;Lcom/helpshift/platform/Device;Lcom/helpshift/user/UserManager;)V

    iput-object v2, v0, Lcom/helpshift/core/HSContext;->configManager:Lcom/helpshift/config/HSConfigManager;

    .line 163
    new-instance v1, Lcom/helpshift/poller/FetchNotificationUpdate;

    iget-object v7, v0, Lcom/helpshift/core/HSContext;->device:Lcom/helpshift/platform/Device;

    iget-object v8, v0, Lcom/helpshift/core/HSContext;->persistentStorage:Lcom/helpshift/storage/HSPersistentStorage;

    iget-object v9, v0, Lcom/helpshift/core/HSContext;->genericDataManager:Lcom/helpshift/storage/HSGenericDataManager;

    iget-object v10, v0, Lcom/helpshift/core/HSContext;->userManager:Lcom/helpshift/user/UserManager;

    iget-object v11, v0, Lcom/helpshift/core/HSContext;->notificationManager:Lcom/helpshift/notification/CoreNotificationManager;

    iget-object v12, v0, Lcom/helpshift/core/HSContext;->httpTransport:Lcom/helpshift/network/HTTPTransport;

    iget-object v13, v0, Lcom/helpshift/core/HSContext;->hsEventProxy:Lcom/helpshift/chat/HSEventProxy;

    move-object v6, v1

    invoke-direct/range {v6 .. v13}, Lcom/helpshift/poller/FetchNotificationUpdate;-><init>(Lcom/helpshift/platform/Device;Lcom/helpshift/storage/HSPersistentStorage;Lcom/helpshift/storage/HSGenericDataManager;Lcom/helpshift/user/UserManager;Lcom/helpshift/notification/CoreNotificationManager;Lcom/helpshift/network/HTTPTransport;Lcom/helpshift/chat/HSEventProxy;)V
    ...
    iget-object v7, v0, Lcom/helpshift/core/HSContext;->persistentStorage:Lcom/helpshift/storage/HSPersistentStorage;

    iget-object v9, v0, Lcom/helpshift/core/HSContext;->userManager:Lcom/helpshift/user/UserManager;

    iget-object v10, v0, Lcom/helpshift/core/HSContext;->hsEventProxy:Lcom/helpshift/chat/HSEventProxy;

    iget-object v11, v0, Lcom/helpshift/core/HSContext;->hsThreadingService:Lcom/helpshift/concurrency/HSThreadingService;

    move-object v6, v2

    move-object v8, v1

    invoke-direct/range {v6 .. v11}, Lcom/helpshift/notification/RequestUnreadMessageCountHandler;-><init>(Lcom/helpshift/storage/HSPersistentStorage;Lcom/helpshift/poller/FetchNotificationUpdate;Lcom/helpshift/user/UserManager;Lcom/helpshift/chat/HSEventProxy;Lcom/helpshift/concurrency/HSThreadingService;)V
