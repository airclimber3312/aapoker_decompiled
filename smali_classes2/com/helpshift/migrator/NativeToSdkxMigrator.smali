...
.method private addNativeSDKVersionLog(I)V
    ...
    const-string v1, " to SDK X version: 10.3.0"
...
.method private readStringFromKVDB(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string v0, "Failed to read the native db or DB does not exist. Key : "

    const/4 v1, 0x0

    .line 347
    :try_start_0
    iget-object v2, p0, Lcom/helpshift/migrator/NativeToSdkxMigrator;->supportKVStoreDBHelper:Lcom/helpshift/migrator/database/HSLegacySupportKeyValueStore;

    invoke-virtual {v2}, Lcom/helpshift/migrator/database/HSLegacySupportKeyValueStore;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {p0, v2}, Lcom/helpshift/migrator/NativeToSdkxMigrator;->toObject([B)Ljava/lang/Object;
    ...
    invoke-virtual {v4, v5, p1, v2}, Lcom/helpshift/migrator/MigrationLogger;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
