...
.method public declared-synchronized handleRemoteRequest(Ljava/lang/String;)V
    ...
    const-string v0, "Call already in progress for user "

    const-string v1, "requestUnreadMessageCount call not allowed for the user "

    monitor-enter p0

    .line 74
    :try_start_0
    iget-object v2, p0, Lcom/helpshift/notification/RequestUnreadMessageCountHandler;->userCallsInProgress:Ljava/util/concurrent/ConcurrentHashMap;
