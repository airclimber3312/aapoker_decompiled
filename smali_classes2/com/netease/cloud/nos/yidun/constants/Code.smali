.class public Lcom/netease/cloud/nos/yidun/constants/Code;
...
.method public static getDes(I)Ljava/lang/String;
    ...
    const-string p0, "could not upload file with unknown reason, please contact with us"

    goto :goto_0

    :cond_0
    const-string p0, "could not upload file with no http response, please contact with us"

    goto :goto_0

    :cond_1
    const-string p0, "could not upload file with http exception, please wait for network recover"

    goto :goto_0

    :cond_2
    const-string p0, "could not upload file with invalid break point offset."

    goto :goto_0

    :cond_3
    const-string p0, "could not upload file with callback error."

    goto :goto_0

    :cond_4
    const-string p0, "could not upload file with server inner error, please contact with us"

    goto :goto_0

    :cond_5
    const-string p0, "could not upload file with invalid token, please change your token before uploading"

    goto :goto_0

    :cond_6
    const-string p0, "bad request, please confirm the sdk usage"

    goto :goto_0

    :cond_7
    const-string p0, "file upload success"
